...
rr = np.array(np.arange(0,0.025,0.005).tolist() + np.arange(0.03,0.11,0.01).tolist() + np.arange(0.12,0.32,0.02).tolist() + np.arange(0.35,0.65,0.05).tolist() + np.arange(0.7,1.3,0.1).tolist() + np.arange(1.4,4.6,0.2).tolist() + [4.8, 5.2] + np.arange(5.6,8.8,0.4).tolist() + np.arange(9.2,14,0.8).tolist() + np.arange(14.8,27.6,1.6).tolist())
